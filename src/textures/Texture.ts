...
import
{
	...
	LinearEncoding, UnsignedByteType, RGBAFormat, //
...
class Texture extends EventDispatcher
{
	...
	constructor( image?, mapping: number = Texture.DEFAULT_MAPPING, wrapS: number = ClampToEdgeWrapping, wrapT: number = ClampToEdgeWrapping, //
		magFilter: number = LinearFilter, minFilter: number = LinearMipMapLinearFilter, format: number = RGBAFormat, type: number = UnsignedByteType, //

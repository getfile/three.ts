...
class KeyframeTrack
{
    ...
    DefaultInterpolation: number = Constant.InterpolateLinear;
    ...
    setInterpolation(interpolation)
    {
        ...
        {
            case Constant.InterpolateDiscrete:
                factoryMethod = this.InterpolantFactoryMethodDiscrete;
                break;

            case Constant.InterpolateLinear:
                factoryMethod = this.InterpolantFactoryMethodLinear;
                break;

            case Constant.InterpolateSmooth:
    ...
    getInterpolation()
    {
        switch (this.createInterpolant)
        {
            case this.InterpolantFactoryMethodDiscrete:
                return Constant.InterpolateDiscrete;

            case this.InterpolantFactoryMethodLinear:
                return Constant.InterpolateLinear;

            case this.InterpolantFactoryMethodSmooth:
                return Constant.InterpolateSmooth;
        }
    }
    ...
    optimize()
    {
        var times = this.times,
            ...
            smoothInterpolation = this.getInterpolation() === Constant.InterpolateSmooth,
            writeIndex = 1,

...
class JSONLoader
{
    ...
    load( url, onLoad, onProgress, onError )
    {
        ...
        let texturePath = this.texturePath && ( typeof this.texturePath === 'string' ) ? this.texturePath : LoaderUtils.extractUrlBase( url );
        ...
        loader.load( url, function ( text )
        {
            ...
            let object = scope.parse( json, texturePath );
    ...
    parseAnimations( json, geometry )
    {
        ...
        if ( geometry.morphTargets )
        {
            ...
            let morphAnimationClips = AnimationClip.CreateClipsFromMorphTargetSequences( geometry.morphTargets, 10 );

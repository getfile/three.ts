...
class Vector4
{
	...
	addScaledVector( v: Vector4, s ): Vector4 
	{
		this.x += v.x * s;
		this.y += v.y * s;
		this.z += v.z * s;
	...
	toArray( array: Array<number>, offset ): Array<number>
	{
	...
	fromBufferAttribute( attribute, index, offset ): Vector4 
	{
		if ( offset !== undefined )

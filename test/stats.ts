...
class Panel
{
	...
	update( value, maxValue )
	{
		...
		this.context.drawImage( this.dom, Panel.GRAPH_X + Panel.PR, Panel.GRAPH_Y, Panel.GRAPH_WIDTH - Panel.PR, Panel.GRAPH_HEIGHT, //
			Panel.GRAPH_X, Panel.GRAPH_Y, Panel.GRAPH_WIDTH - Panel.PR, Panel.GRAPH_HEIGHT );

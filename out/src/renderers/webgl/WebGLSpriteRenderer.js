define(["require", "exports", "../../textures/CanvasTexture", "../../math/Vector3", "../../math/Quaternion"], function (require, exports, CanvasTexture_1, Vector3_1, Quaternion_1) {
    "use strict";
    ...
    class WebGLSpriteRenderer {
        constructor(renderer, gl, state, textures, capabilities) {
            ...
            this.uniforms;
            this.texture;
            this.spritePosition = new Vector3_1.Vector3();
            this.spriteRotation = new Quaternion_1.Quaternion();
        ...
        init() {
            ...
            this.texture = new CanvasTexture_1.CanvasTexture(canvas);
        }
    ...
    exports.WebGLSpriteRenderer = WebGLSpriteRenderer;
});
//# sourceMappingURL=WebGLSpriteRenderer.js.map